# The keybinds are mostly from Ja.koolit but also some of my own changes.
...
# wallpaper / styling stuff
  ...
  - For a persistent wallpaper after dark-light, edit your Execs.conf. Either delete or put # before exec-once=swww query | swww init and delete the # before exec-once = swww init (Lines 6 and 7 on Execs.conf )
